...
InvoiceItem.create(invoice: invoice_2, item: item1, quantity: 1, unit_price: item1.unit_price)
InvoiceItem.create(invoice: invoice_4, item: item2, quantity: 2, unit_price: item2.unit_price)
InvoiceItem.create(invoice: invoice_3, item: item3, quantity: 2, unit_price: item3.unit_price)
InvoiceItem.create(invoice: invoice_1, item: item4, quantity: 3, unit_price: item4.unit_price)
